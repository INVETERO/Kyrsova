...
import com.university.budget.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDTO createUser(UserDTO userDTO, String password) {
        UserEntity user = UserEntity.builder()
                ...
                .role(Role.USER)
                .totalBudget(userDTO.getTotalBudget() != null ? userDTO.getTotalBudget() : BigDecimal.ZERO)
                .build();
    ...
    public UserDTO updateUser(UUID id, UserDTO userDTO, String password) {
        ...
        user = user.toBuilder()
                .username(userDTO.getUsername())
                .passwordHash(password != null ? passwordEncoder.encode(password) : user.getPasswordHash())
                .email(userDTO.getEmail())
                .role(user.getRole())
                .totalBudget(userDTO.getTotalBudget())
                .build();
